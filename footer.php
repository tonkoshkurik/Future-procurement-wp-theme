...
?>
	...
	<section id="contact" class="contact scroll-section">
                <div class="container">
                    <a href="#" data-section="#contact" class="btn contact-location-toggle-btn wow bounce animated" data-wow-duration="1.5s" style="visibility: visible; animation-duration: 1.5s; animation-name: bounce;"><i class="material-icons">mail</i></a>
                    <div class="contact-content-wrapper" style="display: none;">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="contact-info">
                                    <h3 class="contact-title">Contact Info</h3>
                                    <ul class="contact-info-lists list-unstyled">
                                        <li><a href="#"><span class="btn"><i class="material-icons">&#xE0CD;</i></span>+467 288 655 82</a></li>
                                        <li><a href="#"><span class="btn"><i class="material-icons">&#xE0E1;</i></span>info@FutureProcurement.net</a></li>
                                        <li><a href="#"><span class="btn"><i class="material-icons">&#xE894;</i></span>www.FutureProcurement.net</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 ">
                                <div class="contact-form cu-form">
                                    ...
                                    <form action="<?php echo get_stylesheet_directory_uri(); ?>/inc/sendEmail.php" method="post" id="contactForm">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="input-field form-group label-floating">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-field form-group  label-floating">
                                                    ...
                                                    <input id="contactSubject" class="form-control" type="text" name="contactSubject">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-field form-group  label-floating">
                                                    ...
                                                    <textarea id="contactMessage" class="form-control" rows="2" name="contactMessage"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="">
                                                    <input type="submit" name="submit" class="btn btn-raised btn-primary" value="Send">
								...
								<div class="top">
									<div class="container">
						                    ...
						                    <svg width="35px" height="35px" viewBox="0 0 234 228" version="1.1" xmlns="http://www.w3.org/2000/svg">
						                    ...
						                    </svg><br> <span><?php bloginfo( 'name' ); ?><br><br></span>
						                    </div>
						                    <div class="footer-social-area">
						                        <h5>LET’S CONNECT ON</h5>
						                        <ul class="social footer-social">
						                            <li><a href="https://facebook.com/betterpurchasing" class="btn"><i class="icon-facebook"></i></a></li>
						                            <li><a href="#" class="btn"><i class="icon-instagram"></i></a></li>
						                            <li><a href="#" class="btn"><i class="icon-twitter"></i></a></li>
						                            <li><a href="https://www.linkedin.com/in/better-purchasing-development-ba40a3122" class="btn"><i class="icon-linkedin"></i></a></li>
                                                    <li><a href="https://www.youtube.com/channel/UClyPQ6SOvH7GzckhlhdMA3A" class="btn"><i class="icon-youtube"></i></a></li>
                                                </ul>
						                    </div>
						                </div>
								</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="site-info pull-left">
	                        <p>© 2016 Future Procurement AB. All rights reserved. </p>
						</div><!-- .site-info -->
					</div> <!-- col-lg-12 -->
				</div><!-- .row -->
			</div><!-- .containr -->
