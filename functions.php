...
function materialwp_scripts() {
	...
	wp_enqueue_style('material-icon', '//fonts.googleapis.com/icon?family=Material+Icons', array(), '', 'all');

	wp_enqueue_style('lib-style', get_template_directory_uri() . '/inc/lib-style.css', array(), '', 'all');

	wp_enqueue_style('wow', get_template_directory_uri() . '/bower_components/wow/css/libs/animate.css', array(), '', 'all');

	wp_enqueue_style('OwlCarousel', get_template_directory_uri() . '/bower_components/OwlCarousel/owl-carousel/owl.carousel.css', array(), '', 'all');

//	wp_enqueue_style('fullpage-css', get_template_directory_uri() . '/bower_components/fullpage.js/dist/jquery.fullpage.min.css', array(), '', 'all');
	...
	// wp_enqueue_script('wow-js', get_template_directory_uri() . '/bower_components/wow/dist/wow.min.js', array(), '', true);

	// wp_enqueue_script('typed-js', get_template_directory_uri() . '/bower_components/typed.js/js/typed.js', array(), '', true);

	// wp_enqueue_script('owl-js', get_template_directory_uri() . '/bower_components/OwlCarousel/owl-carousel/owl.carousel.min.js', array(), '', true);

//	wp_enqueue_script('fullpage', get_template_directory_uri() . '/bower_components/fullpage.js/dist/jquery.fullpage.min.js', array(), '', true);

	// wp_enqueue_script( 'main-js', get_template_directory_uri() . '/js/main.js', array('jquery'), '', true );

	wp_enqueue_script( 'all-js', get_template_directory_uri() . '/js/all.js', array(), '', true );
